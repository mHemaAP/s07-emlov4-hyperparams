...
def annotate_images(data_list, class_names, output_path):
    for tensor, (image_path,) in data_list:
        ...
        font = ImageFont.truetype("./assets/font/DejaVuSans.ttf", 20)
        draw.text((10, 10),"Predicted - " +class_name, fill="green", font=font)
        draw.text((10, 60), "Actual - " + actual_category, fill="green", font=font)
